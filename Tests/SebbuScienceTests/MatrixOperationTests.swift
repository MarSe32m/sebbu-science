...
struct SolveTests {
    @Test("Matrix<Double>.solve(A:,B:) specific test")
    ...
    @Test("Matrix<Float>.solve(A:,B:) specific test")
    ...
    @Test("Matrix<Complex<Double>>.solve(A:,B:) specific test")
    ...
    @Test("Matrix<Complex<Float>>.solve(A:,B:) specific test")
...
struct SVDTests {
    @Test("Matrix<Double>.singularValueDecomposition(A:) specific")
    ...
    @Test("Matrix<Float>.singularValueDecomposition(A:) specific")
    func matrixSVDFloat() throws {
        ...
        #expect(U.isApproximatelyEqual(to: solutionU, absoluteTolerance: 1e-5))
        #expect(zip(S, solutionS).allSatisfy { $0.0.isApproximatelyEqual(to: $0.1, absoluteTolerance: 1e-5) } )
        #expect(VT.isApproximatelyEqual(to: solutionVT, absoluteTolerance: 1e-5))
    ...
    @Test("Matrix<Complex<Double>>.singularValueDecomposition(A:) specific")
    ...
    @Test("Matrix<Complex<Float>>.singularValueDecomposition(A:) specific")
...
struct LeastSquaresTests {
    @Test("Matrix<Double>.linearLeastSquares(A:) specific")
    ...
    @Test("Matrix<Float>.linearLeastSquares(A:) specific")
    ...
    @Test("Matrix<Complex<Double>>.linearLeastSquares(A:) specific")
    ...
    @Test("Matrix<Complex<Float>>.linearLeastSquares(A:) specific")
