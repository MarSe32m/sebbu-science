...
typedef double(*dq_weight_function_type)(double, double, double, double, double, int);
...
CQUADPACK_EXPORT double G_K15W(dq_function_type f, dq_weight_function_type w, double p1, double p2, double p3,
