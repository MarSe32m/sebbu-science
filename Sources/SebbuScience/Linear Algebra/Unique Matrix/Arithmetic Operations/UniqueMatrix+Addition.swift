...
public extension UniqueMatrix<Double> {
    ...
    @inlinable
    @_transparent
    mutating func addBLAS(_ other: Self, multiplied: T) {
        BLAS.daxpy(elements.count, multiplied, other.elements.baseAddress!, 1, elements.baseAddress!, 1)
    }

    @inlinable
    @_transparent
    mutating func addBLAS(_ other: Self) {
        BLAS.daxpy(elements.count, 1, other.elements.baseAddress!, 1, elements.baseAddress!, 1)
    }
}
...
public extension UniqueMatrix<Float> {
    ...
    @_transparent
    mutating func addBLAS(_ other: Self, multiplied: T) {
        BLAS.saxpy(elements.count, multiplied, other.elements.baseAddress!, 1, elements.baseAddress!, 1)
    }

    @inlinable
    @_transparent
    mutating func addBLAS(_ other: Self) {
        BLAS.saxpy(elements.count, 1, other.elements.baseAddress!, 1, elements.baseAddress!, 1)
    }
}
